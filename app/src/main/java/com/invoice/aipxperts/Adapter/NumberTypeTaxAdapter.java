...
public class NumberTypeTaxAdapter extends BaseAdapter {
    Context context;
    boolean isChecked = false;
    OnDeleteClickTick onDeleteClickTick;
    OnImageClickTick onImageClickTick;
    ArrayList<NumberTaxType> numberTaxTypesList;
    public  NumberTypeTaxAdapter(Context context, ArrayList<NumberTaxType> numberTaxTypesList){
    ...
    public View getView(final int i, View convertView, ViewGroup parent) {
        ...
        binding.edtGstNo.setText(numberTaxTypesList.get(i).getNumberTaxTypeName());
        if(numberTaxTypesList.get(i).isChecked())
        {
        ...
        binding.imgCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    isChecked=false;
                    numberTaxTypesList.get(i).setChecked(isChecked);
                            ...
                            realm.executeTransaction(
                                    new Realm.Transaction() {
                                        ...
                                        public void execute(Realm realm) {
                                            NumberTaxType numberTax = realm.where(NumberTaxType.class).equalTo("NumberTaxTypeId", numberTaxTypesList.get(i).getNumberTaxTypeId()).findFirst();
                                            numberTax.deleteFromRealm();
                                        }
                                    });

                            onDeleteClickTick.OnDeleteClickTick(i, numberTaxTypesList.get(i).getNumberTaxTypeId());
